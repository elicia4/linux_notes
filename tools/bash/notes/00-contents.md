...
These are notes on [the TLCL book.](https://www.linuxcommand.org/tlcl.php)
...
1. [`for`](./10-for.md)
1. [Strings and Numbers](./11-strings_nums.md)
1. [Arrays](./12-arrays.md)
1. [Exotica](./13-exotica.md)
